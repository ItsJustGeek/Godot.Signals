namespace Godot {
    public static partial class Signals {
        public class RigidBody2D : CollisionObject2D {
            /// <summary>
            ...
            /// <summary>
            /// Emitted when a body enters into contact with this one. Reports colliding shape information. See <see cref="Godot.CollisionObject2D"/> for shape index information.  <br/>
            ...
            /// <summary>
            /// Emitted when a body exits contact with this one. Reports colliding shape information. See <see cref="Godot.CollisionObject2D"/> for shape index information. <br/>
            /// Requires <see cref="Godot.RigidBody.ContactMonitor"/> to be set to true and <see cref="Godot.RigidBody.ContactsReported"/> to be set high enough to detect all the collisions. <br/>
